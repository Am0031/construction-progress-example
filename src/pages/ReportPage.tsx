...
const REPORT_SECTIONS = [
  { id: 'programme-summary', label: 'Programme summary' },
  { id: 'status-breakdown', label: 'Status breakdown' },
  { id: 'top-risks', label: 'Top risks' },
  { id: 'open-blockers', label: 'Open blockers' },
  { id: 'resourcing', label: 'Resourcing' },
  { id: 'upcoming-milestones', label: 'Upcoming milestones' },
] as const;
